...
export default class NavbarComponent extends Component{
    render(){
        return(
            <>
            <Nav className="justify-content-center align-middle" justify = "true" activeKey="/">
                ...
                <Nav.Item className="nav-item align-middle">
                    <Link className = "" to = "/store">
                ...
                <Nav.Item className="nav-logo align-middle">
                    <Link className = "" to = "/">
